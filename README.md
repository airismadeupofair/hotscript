...
- [x] Tuples
  ...
  - [x] `Flatten<Tuple, Depth>`: Flattens a Tuple (like `Array.prototype.flat`) up to a specified `Depth` while preserving item order and spreads. `Depth` has a default of `1` 
